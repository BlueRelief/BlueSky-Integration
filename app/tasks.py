...
from app.services.bluesky import fetch_posts
from app.services.analysis import analyze_posts
...
@celery_app.task(name="app.tasks.collect_and_analyze")
def collect_and_analyze():
    ...
    try:
        ...
        # Smart optimization: Only run AI analysis if there are new posts
        if saved_count > 0:
