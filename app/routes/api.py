...
from app.tasks import collect_and_analyze
from app.services.database_service import get_recent_disasters, get_collection_stats
from app.database import get_db
from app.models import Post, Disaster, CollectionRun
...
def trigger_collection():
    ...
    task = collect_and_analyze.delay()  # type: ignore
    return {
        "status": "accepted",
